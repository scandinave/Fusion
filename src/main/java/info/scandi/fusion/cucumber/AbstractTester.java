...
/**
 * Abstract class that provides commons variables and functions for tester
 * implementations.
 * 
 * @author Scandinave
 */
public abstract class AbstractTester implements Serializable {
	...
	/**
	 * Default regex for cucumber steps definitions. This regex accept string in the
	 * form "string" or &#60string&#62
	 */
