...
public class PropsUtils {
	...
	/**
	 * Format des clés des propriétés à concerver. Explication : - (%s) : 1
	 * chaîne de caractère apposée via String.format trouvée 0 ou 1 fois
	 * (condition), - *
	 * [a-zA-Z]* : 1 chaîne alphabétique de n caractères, - \\. : 1 caractère
	 * point, - [a-zA-Z]* : 1 chaîne alphabétique de n caractères.
	 */
	...
	private static final String NAME = "fusion.properties";
	...
	/**
	 * Chargement du fichier properties en fonction du chemin d'accès en
	 * paramètre
	 */
	private static void load() throws UtilitaireException {
		...
		LOGGER.debug(String.format("%d propriétés chargées.", properties.size()));
	}
}
